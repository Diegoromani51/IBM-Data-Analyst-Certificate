...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        avr_data=yearly_data.groupby('Month')['Automobile_Sales'].mean().reset_index()
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div(className='chart-item', children=[html.Div(Y_chart1),html.Div(Y_chart3)]),#style={'display': 'flex'}),
                html.Div(className='chart-item', children=[html.Div(Y_chart2),html.Div(Y_chart4)])#style={'display': 'flex'})
                ]
